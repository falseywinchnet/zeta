#!/usr/bin/env python3
"""Exact no-FLINT proof of q>0, F2>0, and C4>0.
...
used. This maintained copy is the finite algebraic core of the paper verifier.
"""
...
def main() -> None:
    ...
    print("status=no-flint sweep-free global q,F2,C4 proof passed")
