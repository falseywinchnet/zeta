...
def main():
    ...
    c_user_pf5 = cite(
        ...
        ["kernel", "pf5", "pfinf"],
        "/Users/quentinkuttenkuler/Downloads/The Riemann Kernel is Not a Polya Frequency Function of Infinite Order.pdf",
    )
    c_user_pf2 = cite(
        "Rainstar",
        "Towards the Riemann Hypothesis: Establishing the PF2 Property of the Riemann Kernel, 2025-12-21, supplied manuscript.",
        ["kernel", "pf2", "logc"],
        "/Users/quentinkuttenkuler/Downloads/RH is at least PF2.pdf",
    )
    c_pf5 = cite(
