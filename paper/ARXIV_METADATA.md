...
Secondary subject context: math.NT, math.PR
...
Upload `paper/ax.tar`. It contains only the flattened `main.tex`; no auxiliary,
log, PDF, bibliography database, hidden, or repository files are included.
