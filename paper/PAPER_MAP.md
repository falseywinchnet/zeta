...
|---|---|---|---|---|
| `S00` | `sections/S00-abstract.tex` | Claim, method, evidence boundary | `R145`, `R164`, `CERT9` | ready |
| `S01` | `sections/S01-introduction.tex` | Scope, exact-order statement, RH boundary | `R81`, `R145`, `R164` | ready |
...
| `S11` | `sections/S11-reproducibility.tex` | Human proof vs replay boundary and audit order | `CERT2`, `CERT3`, `CERT5`, `CERT9` | ready |
...
| `A4` | `appendices/A4-provenance.tex` | Claim-to-file replay table | `CERT2`, `CERT3`, `CERT5`, `CERT9` | ready |
...
No critique position is currently unfilled. A new advancement round is not
