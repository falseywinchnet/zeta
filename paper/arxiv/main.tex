...
remaining theta modes; \appref{app:tail} lists the domains, degrees, and minimum
coefficients. The transport algebra is proved in the text, and the order-five
...
Micha\l{}owski also studied order-five Toeplitz obstructions numerically
\cite{michalowski}; here a direct origin-confluent determinant suffices.
...
for symbolic calculation, implementation, drafting, and review. The author
...
\texttt{pf4-paper-v1.0.0}; their SHA-256 values are listed in
...
\secref{sec:reproducibility} checks the five corresponding verifier outputs.
