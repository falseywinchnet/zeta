...
\section{Exact order-five threshold certificate}\label{app:pf5-threshold}

This appendix records the finite inequalities used in
Theorem~\ref{thm:confluent-threshold}. All endpoints lie on
