...
/-!
# CERT12 outer C4 margin polynomials

Exact shifted-coefficient positivity data for the two-mode cleared-C4 margin
on the complete outer half-line.
-/
namespace PF4.CERT12C4OuterMargins
