...
/-!
# Transport expectation object identity

This file proves PO-0038.  The paper primitive, elementary primitives, endpoint
transport object, measures, and Bochner expectations are defined independently;
their equality is obtained only after the retained-boundary integral identities
and the cleared-denominator endpoint cancellation.
-/

namespace PF4.TransportObject
...
/-- PO-0038: the independently expanded paper object is
