...
Maintained terminal translation-quotient conversion. Every coordinate
realization and remaining analytic kernel input is exposed literally.
-/

namespace PF4.TranslationQuotientPsi
...
/-- Terminal positivity from an explicit coordinate-`Psi` decrease theorem.
The target terminal sign is not a premise. -/
...
/-- Integrated P000115/P000116 boundary: determinant positivity supplies the
coordinate-`Psi` decrease required by the exact terminal quotient identity.
No terminal sign or monotonicity premise is assumed. -/
theorem terminalQuotD_pos_of_determinantC4
    {Φ Φ1 Φ2 Φ3 q1 Q Q1 Q2 Q3 Q4 : ℝ → ℝ}
    (hΦ : ∀ u, HasDerivAt Φ (Φ1 u) u)
    (hΦ1 : ∀ u, HasDerivAt Φ1 (Φ2 u) u)
    (hΦ2 : ∀ u, HasDerivAt Φ2 (Φ3 u) u)
    (hΦpos : ∀ u, 0 < Φ u)
    ...
    (hLambda : ∀ x m r, x < m → m < r →
      0 < lowerLambda (logSlope Φ Φ1) (kernelCurvature Φ Φ1 Φ2) x m r)
    (hQreal : ∀ u, Q (kernelCoordinate (logSlope Φ Φ1) u) =
      kernelCurvature Φ Φ1 Φ2 u)
    (hQ1real : ∀ u, Q1 (kernelCoordinate (logSlope Φ Φ1) u) =
      q1 u / kernelCurvature Φ Φ1 Φ2 u)
  ...
  exact terminalQuotD_pos_of_coordinatePsi_decrease hΦ hΦ1 hΦ2 hΦpos
    hqpos hq hLambda hQreal hQ1real hPsiDecrease hac hcb hbd

end PF4.TranslationQuotientPsi
