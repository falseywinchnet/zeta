...
```sh
/Users/quentinkuttenkuler/miniforge3/bin/python3 audit_supplied_witness.py
/Users/quentinkuttenkuler/miniforge3/bin/python3 verify_blowup_identity.py
/Users/quentinkuttenkuler/miniforge3/bin/python3 certify_jhat_cells.py
/Users/quentinkuttenkuler/miniforge3/bin/python3 -m py_compile *.py
```

The preserved negative experiments are replayed with:

```sh
/Users/quentinkuttenkuler/miniforge3/bin/python3 certify_jhat_rectangle.py
/Users/quentinkuttenkuler/miniforge3/bin/python3 certify_jhat_divided.py
```
