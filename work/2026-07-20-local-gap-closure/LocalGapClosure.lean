...
Advancement candidate.  These are local counterparts of the maintained
closed-gap theorems.  Continuity is required only on `Icc p w`.
-/

namespace PF4.Advancement.LocalGapClosure
...
theorem actualCoordinateGap_properties
  ...
  have hrange : Icc p w ⊆ Set.range (kernelCoordinate S) := by
    dsimp [p, w]
    exact kernelCoordinate_Icc_subset_range hS hqpos (hxm.le.trans hmr.le)
...
end PF4.Advancement.LocalGapClosure

#print axioms PF4.Advancement.LocalGapClosure.coordinateGap_pos_on_Icc
#print axioms PF4.Advancement.LocalGapClosure.coordinateGap_continuousOn_of_normalized
#print axioms PF4.Advancement.LocalGapClosure.actualCoordinateGap_properties
#print axioms PF4.Advancement.LocalGapClosure.coordinatePartialXiPsi_neg_on_Icc_of_centralIdentity
